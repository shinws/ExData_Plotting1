...
mydata_0201_0202$Sub_metering_1 <- as.numeric(as.character(mydata_0201_0202$Sub_metering_1))
mydata_0201_0202$Sub_metering_2 <- as.numeric(as.character(mydata_0201_0202$Sub_metering_2))
mydata_0201_0202$Sub_metering_3 <- as.numeric(as.character(mydata_0201_0202$Sub_metering_3))
mydata_0201_0202$Voltage <- as.numeric(as.character(mydata_0201_0202$Voltage))
...
plot(mydata_0201_0202$Date2, mydata_0201_0202$Voltage, type='l', 
